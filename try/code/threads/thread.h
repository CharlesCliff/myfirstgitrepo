...
//
//LOG of my part
//1.line 116 about the define of usrID & threadID;
//
//
//
#ifndef THREAD_H
...
class Thread {
  private:
    ...
    //NOTE: This is the my own part,new define usrID && threadID
    int usrID;
    int threadID;
    int priority;
  ...
  public:
    ...
    void Print() { printf("%s,%d priority ", name,priority); }
    void setUsrID(int id){usrID = id;}
    void setThreadID(int id){threadID = id;}
    int getThreadID(){return threadID;}
    int getUsrID(){return usrID;}
    void setPriority(int prio){priority = prio;};
    int getPriority(){return priority;}
    void PrintThreadID(){printf("%d, ",threadID);}
    //int getTimeLeft();
    ...
    bool getPreempted(){return preempted;}
    void setPreempted(bool f){preempted = f;}
    void setTimeLeft(int lt){timeleft = lt;}
  ...
  private:
    ...
    bool preempted;
    bool interrupted;
    List *joinList;          //List of threads wait for this thread to end.
