...
enum ExceptionType { NoException,           // Everything ok!
             ...
             TLBPageFaultException,  // tlb not found the page
             PTEPageFaultException,  //Page Table not found the page
...
// Routines internal to the machine simulation -- DO NOT call these 
    ...
    //------------------------------------------------------------------------
    void TLBSwap(int badVAddr);
    void TranslatePTE(int virtAddr); // search the pagetable for the virtAddr
    char *disk;
    OpenFile *swap;
    int noffInitDataOffset;
    int noffCodeOffset;
    ...
    void UpdateTLB(); ///added by chenYang @2014/4/15
    void ClearRBit();
    int SwitchOutTLB();
    void SortTLB();
    int LRU_PTE();
